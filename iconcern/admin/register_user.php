...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['register_user'])) {
    ...
    if ($role === 'admin' && empty($department_id)) {
        $error = 'College/Department selection is required for admin registration. Select the college/department you will be administering (CCIS, CCJS, COED, CON, CAT, CEA, COM).';
    } else {
                    ...
                    <div class="form-group" id="departmentGroup">
                        ...
                        <select id="department_id" name="department_id">
                            ...
                            <?php if (!empty($collegeDepartments)): ?>
                                <?php foreach ($collegeDepartments as $d): ?>
                                    <option value="<?php echo $d['department_id']; ?>" <?php echo (isset($_POST['department_id']) && $_POST['department_id'] == $d['department_id']) ? 'selected' : ''; ?>>
