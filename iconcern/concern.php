    ...
    <div class="container">
        ...
        <div class="form-card">
            ...
            <div class="form-group">
                ...
                <p>
                    <?php if ($concern_data['predicted_category']): ?>
                        <span class="badge badge-info"><?php echo htmlspecialchars($concern_data['predicted_category']); ?></span>
                        <?php if ($concern_data['confidence_score']): ?>
                            <span style="margin-left: 0.5rem; color: var(--text-secondary);">
                                (<?php echo number_format($concern_data['confidence_score'] * 100, 1); ?>% confidence)
                            </span>
                        <?php endif; ?>
                    <?php else: ?>
                        <span style="color: var(--text-secondary);">Not classified yet</span>
                    <?php endif; ?>
                </p>
            </div>
