...
<head>
    ...
    <style>
        ...
        .concerns-admin-table {
            width: 100%;
            table-layout: fixed;
        }
        .concerns-admin-table th,
        .concerns-admin-table td {
            vertical-align: top;
        }
        .concerns-admin-table th {
            white-space: nowrap;
        }
        .concerns-admin-table th:nth-child(1),
        .concerns-admin-table td:nth-child(1) { width: 34px; }
        .concerns-admin-table th:nth-child(2),
        .concerns-admin-table td:nth-child(2) { width: 64px; }
        .concerns-admin-table th:nth-child(3),
        .concerns-admin-table td:nth-child(3) { width: 150px; }
        .concerns-admin-table th:nth-child(4),
        .concerns-admin-table td:nth-child(4) { width: 130px; }
        .concerns-admin-table th:nth-child(5),
        .concerns-admin-table td:nth-child(5) { width: 140px; }
        .concerns-admin-table th:nth-child(6),
        .concerns-admin-table td:nth-child(6) { width: 130px; }
        .concerns-admin-table th:nth-child(7),
        .concerns-admin-table td:nth-child(7) { width: 120px; }
        .concerns-admin-table th:nth-child(8),
        .concerns-admin-table td:nth-child(8) { width: 95px; }
        .concerns-admin-table th:nth-child(9),
        .concerns-admin-table td:nth-child(9) { width: 105px; }
        .concerns-admin-table th:nth-child(10),
        .concerns-admin-table td:nth-child(10) { width: 120px; }
        .concern-college,
        .concern-department {
            line-height: 1.35;
            word-break: normal;
                        ...
                        <?php else: ?>
                            <?php foreach ($concerns as $c): ?>
                                <tr class="concern-row">
                                    ...
                                    <td class="concern-college"><?php echo htmlspecialchars($c['college_name'] ?? 'N/A'); ?></td>
                                    <td class="concern-department">
                                    ...
                                    <td>
                                        <?php if ($c['predicted_category']): ?>
                                            <span class="badge badge-info concern-category"><?php echo htmlspecialchars($c['predicted_category']); ?></span>
