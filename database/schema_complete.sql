-- ============================================
-- iconcern Database Schema - COMPLETE
...
-- DROP DATABASE IF EXISTS iconcern_db;
...
('Finance Office', 'Tuition and financial matters'),
('Registrar', 'Academic records and enrollment'),
...
-- ============================================
-- This password hash is generated using PHP password_hash('admin123', PASSWORD_BCRYPT)
-- Multiple valid hashes for 'admin123' (any of these will work):
...
-- Alternative: If the above doesn't work, use this hash (also valid for 'admin123'):
-- INSERT INTO users (username, password, full_name, email, role) VALUES
-- ('admin', '$2y$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'System Administrator', 'admin@nwssu.edu.ph', 'admin')
-- ON DUPLICATE KEY UPDATE password = '$2y$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy';

-- Insert Sample Staff Users (password: admin123)
...
--   Username: staff1
--   Password: admin123
--   Email: staff1@nwssu.edu.ph
--
-- Student Accounts:
--   Username: student1
--   Password: admin123
--   Email: student1@nwssu.edu.ph
--
--   Username: student2
--   Password: admin123
--   Email: student2@nwssu.edu.ph
-- ============================================
